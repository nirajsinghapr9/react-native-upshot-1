...
+ (UIViewController * _Nullable)makeWithActivity:(BKActivity * _Nonnull)activity sessionId:(NSString * _Nonnull)sessionId appuid:(NSString * _Nonnull)appuid dismissBlock:(void (^ _Nonnull)(NSString * _Nullable))dismissBlock SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
